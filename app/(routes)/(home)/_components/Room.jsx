...
const Room = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black">
      <div className="w-1/3 h-[500px] bg-amber-500 flex flex-col items-center gap-8 p-4 rounded-lg">
        <h1 className="text-2xl pt-2 text-black font-bold">WELCOME CHAT</h1>
        <div className="flex flex-col gap-4 w-full py-4">
          <input
            className="bg-blue-800 p-4 rounded-lg outline-none"
            type="text"
        ...
        <button
          className="w-full bg-red-600 hover:bg-red-700 p-4 rounded-lg cursor-pointer text-center"
          onClick={sendRoom}
        >
          CHAT!
        </button>
